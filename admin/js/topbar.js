...
AgriPricePH.Topbar = (function () {
  ...
  const SEARCH_INDEX = [
    ...
    { id: 'lstm', group: 'Modules', label: 'LSTM Model', route: 'lstm-model',
      keywords: ['lstm', 'lstm model', 'neural network', 'model architecture'] },
    { id: 'metrics', group: 'Modules', label: 'Performance Metrics', route: 'metrics',
      keywords: ['metrics', 'mae', 'rmse', 'accuracy', 'performance'] },
    { id: 'corr', group: 'Modules', label: 'Correlation Analysis', route: 'correlation',
      keywords: ['correlation', 'heatmap', 'correlation matrix'] },
